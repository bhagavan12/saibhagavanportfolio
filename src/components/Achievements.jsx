...
export default function Achievements() {
  ...
  return (
    <section className="achievements" style={{ position: "relative" }}>
      ...
      <h3 style={{ fontSize: "1.3rem" }}>Acheivements</h3>
        ...
        <div>
          <div className="" style={{ border: '1px solid #ddd', borderRadius: '4px 4px 0px 0px', padding: "28px 7px 0px 7px", boxShadow: '0 4px 12px rgba(18, 18, 18, 0.03)', textAlign: 'center', width: "140px", cursor: "pointer" }} onClick={() => openLinkInNewTab("https://www.hackerrank.com/certificates/6dac59afeb89")}>
            ...
            <p >Frontend
              ...
              <i className="truncate" style={{ fontSize: '0.8rem', marginTop: "4px", color: "rgb(134, 132, 132)" }}>Issuer: Hackerank</i>
            </p>
          </div>
          <div style={{ border: '1px solid #ddd', borderTop: "0px solid #ddd", backgroundColor: "rgba(205, 202, 202, 0.24)", fontSize: "0.6rem", padding: "5px 6px", width: "91.5%", color: "rgb(160, 158, 158)", alignItems: "center", display: "flex", justifyContent: "center", margin: "auto" }}>
            PROVIDED BY
