...
export default function Contact() {
  ...
  return (
    <section className={`contact-wrapper ${theme}`} id="contact">
      <div className="contact-left">
        <h2>Let’s Connect</h2>
        <p>Reach out anytime — open for collaborations & opportunities!</p>
        <div className="contact-info">
          <p style={{ display: 'flex', gap: '5px' }}>
            <span className="streamline--gmail" alt="Mail" style={{ width: '25px' }} />
            2100032454cseh@gmail.com
          </p>
          <p style={{ display: 'flex', gap: '5px' }}>
            <span className="line-md--linkedin" alt="LinkedIn" />
            <a
              href="https://www.linkedin.com/in/javvadi-sai-bhagavan-793960248/"
              target="_blank"
          ...
          <p style={{ display: 'flex', gap: '5px' }}>
            ...
            <a href="https://github.com/bhagavan12" target="_blank" rel="noopener noreferrer">
              GitHub
            </a>
          </p>
        </div>
